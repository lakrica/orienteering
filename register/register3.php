				...
				<div id="event">
					...
					<div class="header">
						...
						<div id="event-line-register">
							<p class="solis collon">3.Extras</p>
							<p class=""><img src="img/3solis.png" /></p>
						</div>	
					</div>	
					<div class="clear"></div>
			...
			<div id="register">
				<div id="form">	
					...
					<div class="two-thirds">
						      <form  id="sac" action="register4.php#event">
							  	<input type="checkbox" value="extra" class="extra"  name="sac" />
									<div class="extras">
										<h3>Riga Sightseeing tour</h3>
										<p>
										17th of April at 16:00<br />
									    2 hours<br />
									    Price: 16 euros</p><br /><p>&nbsp;</p></div><br /> 
									<div class="clear"></div>		
							  	<input type="checkbox" value="extra" class="extra"  name="sac" />
								<div class="extras">
									<h3>Souveniers from Magnēts</h3>
									Magnēts orienteering T shirt. <br />
									Sizes: M, L.<br />
									Price: 21 eur</p>
									<img width="150px" src="http://www.magnets.lv/uploads/veikals/Magneta_neilons_2011_2.jpg" /></div>
